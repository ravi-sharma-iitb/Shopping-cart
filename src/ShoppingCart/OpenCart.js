  ...
  return (
    <Grid container>
      <Grid item xs={12} className="shopping-cart">
        <Grid container id="product-list" style={{overflowY: 'scroll', height: window.innerHeight}}>
            <Grid
              item
              ...
              xs={12}>
                <Box p={4}>
                  <Grid container>
                      ...
                      <Grid item xs={12}>
                        <button className="checkout-button" style={{textAlign: "center", backgroundColor: '#0c0b10'}}>
                          checkout
                        </button>
                      </Grid>
                  </Grid>
...
const OpenCart = ({state, setState, productCount}) => {
  ...
  console.log('products in open cart:', products);
  return (
    <Drawer 
      anchor="right" 
      variant={"persistent"}
